...
export default function VerPagosFreelancerPage()
{
    ...
    async function obtenerPagos()
    {
        try
        {
            ...
            console.log("Pagos freelancer:", data);
            ...
            if (!response.ok)
            {
                throw new Error(
                    ...
                    "No se pudieron cargar tus fondos"
                );
            }
        ...
        <main style={styles.page}>
            ...
            <section style={styles.hero}>
                ...
                <div>
                    ...
                    <p style={styles.text}>
                        Revisa los pagos asociados a tus propuestas aceptadas,
                        el cliente que pagó, el proyecto y el estado del dinero.
                    </p>
                </div>

                <div style={styles.summary}>
                    <span>Total de fondos</span>
...

            {
                ...
                ? (
                    <section style={styles.empty}>
                        <h2>No tienes fondos registrados</h2>

                        <p>
                            Cuando un cliente acepte tu propuesta y registre el pago,
                            aparecerá aquí.
                        </p>
                    </section>
                )
                                ...
                                >
                                    ...
                                    <div style={styles.grid}>
                                        ...
                                        <div>
                                            ...
                                            <strong>
                                                {pago.cliente?.name ?? "No disponible"}
                                            </strong>
