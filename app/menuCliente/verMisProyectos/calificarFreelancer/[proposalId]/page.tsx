...
import "./calificarFreelancer.css";
...
export default function CalificarFreelancerPage() {
    ...
    function volver() {
        if (proposal?.project?.id) {
            router.push(`/menuCliente/verMisProyectos/verAvance/${proposal.project.id}`);
            return;
        }
    ...
    return (
        <main className="review-page">
            <section className="review-card">
                ...
                <h1>Calificar freelancer</h1>

                <p className="review-subtitle">
                    Evalúa el trabajo realizado por el freelancer en este proyecto.
                </p>
                ...
                {alreadyReviewed ? (
                    ...
                    <form className="review-form" onSubmit={enviarReview}>
                        ...
                        <textarea
                            ...
                            placeholder="Ejemplo: Entregó a tiempo, buena comunicación y cumplió con lo solicitado..."
                            maxLength={1000}
                        />
